...
const Home = () => {
  ...
  const [metamaskPresent, setMetamaskPresent] =
    useRecoilState(metamaskPresentAtom);
  ...
  console.log("containsToken", containsToken);
    ...
    if (metamaskPresent) {
      ...
      if (account) {
        const contract = new ethers.Contract(
          v1Details.contract_address,
          v1Details.contract_abi,
          provider
        );
